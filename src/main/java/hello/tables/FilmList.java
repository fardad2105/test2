...
import hello.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
    ...
    private static final long serialVersionUID = -1317885432;
     ...
     */
    public final TableField<FilmListRecord, MpaaRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(hello.enums.MpaaRating.class), this, "");
