...
import hello.Public;
import hello.tables.records.CustomerListRecord;
...
public class CustomerList extends TableImpl<CustomerListRecord> {
    ...
    private static final long serialVersionUID = -173420649;
     ...
     */
    public final TableField<CustomerListRecord, String> ADDRESS = createField("address", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");
     ...
     */
    public final TableField<CustomerListRecord, String> PHONE = createField("phone", org.jooq.impl.SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>public.customer_list.city</code>.
     */
    public final TableField<CustomerListRecord, String> CITY = createField("city", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>public.customer_list.country</code>.
     */
    public final TableField<CustomerListRecord, String> COUNTRY = createField("country", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");
     ...
     */
    public final TableField<CustomerListRecord, Short> SID = createField("sid", org.jooq.impl.SQLDataType.SMALLINT, this, "");
