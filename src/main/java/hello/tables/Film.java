...
public class Film extends TableImpl<FilmRecord> {
    ...
    private static final long serialVersionUID = -184876656;
     ...
     */
    public final TableField<FilmRecord, MpaaRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR.defaultValue(org.jooq.impl.DSL.field("'G'::mpaa_rating", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(hello.enums.MpaaRating.class), this, "");
