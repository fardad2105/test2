...
import hello.tables.records.AddressRecord;
import hello.tables.records.CategoryRecord;
...
import hello.tables.records.StaffRecord;
import hello.tables.records.StoreRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<AddressRecord, CityRecord> ADDRESS__FK_ADDRESS_CITY = Internal.createForeignKey(hello.Keys.CITY_PKEY, Address.ADDRESS, "address__fk_address_city", Address.ADDRESS.CITY_ID);
        public static final ForeignKey<CityRecord, CountryRecord> CITY__FK_CITY = Internal.createForeignKey(hello.Keys.COUNTRY_PKEY, City.CITY, "city__fk_city", City.CITY.COUNTRY_ID);
        public static final ForeignKey<CustomerRecord, AddressRecord> CUSTOMER__CUSTOMER_ADDRESS_ID_FKEY = Internal.createForeignKey(hello.Keys.ADDRESS_PKEY, Customer.CUSTOMER, "customer__customer_address_id_fkey", Customer.CUSTOMER.ADDRESS_ID);
        public static final ForeignKey<FilmRecord, LanguageRecord> FILM__FILM_LANGUAGE_ID_FKEY = Internal.createForeignKey(hello.Keys.LANGUAGE_PKEY, Film.FILM, "film__film_language_id_fkey", Film.FILM.LANGUAGE_ID);
        public static final ForeignKey<FilmActorRecord, ActorRecord> FILM_ACTOR__FILM_ACTOR_ACTOR_ID_FKEY = Internal.createForeignKey(hello.Keys.ACTOR_PKEY, FilmActor.FILM_ACTOR, "film_actor__film_actor_actor_id_fkey", FilmActor.FILM_ACTOR.ACTOR_ID);
        public static final ForeignKey<FilmActorRecord, FilmRecord> FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY = Internal.createForeignKey(hello.Keys.FILM_PKEY, FilmActor.FILM_ACTOR, "film_actor__film_actor_film_id_fkey", FilmActor.FILM_ACTOR.FILM_ID);
        public static final ForeignKey<FilmCategoryRecord, FilmRecord> FILM_CATEGORY__FILM_CATEGORY_FILM_ID_FKEY = Internal.createForeignKey(hello.Keys.FILM_PKEY, FilmCategory.FILM_CATEGORY, "film_category__film_category_film_id_fkey", FilmCategory.FILM_CATEGORY.FILM_ID);
        public static final ForeignKey<FilmCategoryRecord, CategoryRecord> FILM_CATEGORY__FILM_CATEGORY_CATEGORY_ID_FKEY = Internal.createForeignKey(hello.Keys.CATEGORY_PKEY, FilmCategory.FILM_CATEGORY, "film_category__film_category_category_id_fkey", FilmCategory.FILM_CATEGORY.CATEGORY_ID);
        public static final ForeignKey<InventoryRecord, FilmRecord> INVENTORY__INVENTORY_FILM_ID_FKEY = Internal.createForeignKey(hello.Keys.FILM_PKEY, Inventory.INVENTORY, "inventory__inventory_film_id_fkey", Inventory.INVENTORY.FILM_ID);
        public static final ForeignKey<PaymentRecord, CustomerRecord> PAYMENT__PAYMENT_CUSTOMER_ID_FKEY = Internal.createForeignKey(hello.Keys.CUSTOMER_PKEY, Payment.PAYMENT, "payment__payment_customer_id_fkey", Payment.PAYMENT.CUSTOMER_ID);
        public static final ForeignKey<PaymentRecord, StaffRecord> PAYMENT__PAYMENT_STAFF_ID_FKEY = Internal.createForeignKey(hello.Keys.STAFF_PKEY, Payment.PAYMENT, "payment__payment_staff_id_fkey", Payment.PAYMENT.STAFF_ID);
        public static final ForeignKey<PaymentRecord, RentalRecord> PAYMENT__PAYMENT_RENTAL_ID_FKEY = Internal.createForeignKey(hello.Keys.RENTAL_PKEY, Payment.PAYMENT, "payment__payment_rental_id_fkey", Payment.PAYMENT.RENTAL_ID);
        public static final ForeignKey<RentalRecord, InventoryRecord> RENTAL__RENTAL_INVENTORY_ID_FKEY = Internal.createForeignKey(hello.Keys.INVENTORY_PKEY, Rental.RENTAL, "rental__rental_inventory_id_fkey", Rental.RENTAL.INVENTORY_ID);
        public static final ForeignKey<RentalRecord, CustomerRecord> RENTAL__RENTAL_CUSTOMER_ID_FKEY = Internal.createForeignKey(hello.Keys.CUSTOMER_PKEY, Rental.RENTAL, "rental__rental_customer_id_fkey", Rental.RENTAL.CUSTOMER_ID);
        public static final ForeignKey<RentalRecord, StaffRecord> RENTAL__RENTAL_STAFF_ID_KEY = Internal.createForeignKey(hello.Keys.STAFF_PKEY, Rental.RENTAL, "rental__rental_staff_id_key", Rental.RENTAL.STAFF_ID);
        public static final ForeignKey<StaffRecord, AddressRecord> STAFF__STAFF_ADDRESS_ID_FKEY = Internal.createForeignKey(hello.Keys.ADDRESS_PKEY, Staff.STAFF, "staff__staff_address_id_fkey", Staff.STAFF.ADDRESS_ID);
        public static final ForeignKey<StoreRecord, StaffRecord> STORE__STORE_MANAGER_STAFF_ID_FKEY = Internal.createForeignKey(hello.Keys.STAFF_PKEY, Store.STORE, "store__store_manager_staff_id_fkey", Store.STORE.MANAGER_STAFF_ID);
        public static final ForeignKey<StoreRecord, AddressRecord> STORE__STORE_ADDRESS_ID_FKEY = Internal.createForeignKey(hello.Keys.ADDRESS_PKEY, Store.STORE, "store__store_address_id_fkey", Store.STORE.ADDRESS_ID);
    }
}
